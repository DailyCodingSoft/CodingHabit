...
- [ ] **Generate habit access code after creation**
  ...
  - [x] **Success modal after habit creation**
    - Show success message when habit is created
    - Display button to go to share screen
    - Modal appears after form submission
    - Only shows if backend returns success (200/201)
  - [x] **Define access code encoding format**
    - Format: 8 characters divided as XXXX-XXXX (e.g., A2E3-4F7B)
    - Uses two UUIDs: last 4 chars of UUID1 + first 4 chars of UUID2
